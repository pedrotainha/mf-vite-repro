...
export { createShellStore, onSliceChange } from './shell-store';
...
export type { SelectionsSliceState } from './slices/selections.slice';
export { selectionsSlice } from './slices/selections.slice';

// Types
export type { DynamicSlicesState, SliceDescriptor, SliceFactory } from './types';
