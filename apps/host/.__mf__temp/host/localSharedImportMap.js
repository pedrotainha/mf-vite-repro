...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@repro/pkg-a": async () => {
          let pkg = await import("__mf__virtual/host__prebuild___mf_0_repro_mf_1_pkg_mf_2_a__prebuild__.js");
            return pkg;
        }
      ,
        "@repro/pkg-b": async () => {
          let pkg = await import("__mf__virtual/host__prebuild___mf_0_repro_mf_1_pkg_mf_2_b__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
